...
export default function Dispatch(){
  const [jobs,setJobs]=useState([]),[techs,setTechs]=useState([]),[assignments,setAssignments]=useState([]),[loading,setLoading]=useState(true),[error,setError]=useState(''),[selected,setSelected]=useState(null),[techId,setTechId]=useState(''),[role,setRole]=useState('assigned'),[saving,setSaving]=useState(false)
  async function load(){
